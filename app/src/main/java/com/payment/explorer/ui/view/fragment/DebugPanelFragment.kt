...
import com.payment.explorer.databinding.FragmentDebugPanelBinding
...
import com.payment.explorer.ui.viewModel.DebugPanelViewModel
...
class DebugPanelFragment : MVVMFragment<DebugPanelViewModel, FragmentDebugPanelBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        DebugPanelManager.debugPanelState.observe(viewLifecycleOwner) {
            val ratio = when (it) {
                DebugPanelManager.DebugPanelState.HALF_EXPANDED -> 0.5F
                DebugPanelManager.DebugPanelState.EXPANDED -> 1.0F
                else -> 0F
            }
